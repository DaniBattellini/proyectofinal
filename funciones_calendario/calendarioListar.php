...
if($action == 'listar'){
    ...
    if (count($where)>0) $sWhere =' WHERE ' . implode(" and ",$where);
 	$sWhere .= " ORDER BY c.AnioLectivo desc, c.fechaInicioEvento asc ";
    ...
    while ($row=mysqli_fetch_assoc($query)) {
			...
			$indice = $pagina + $c;
			$espacio = "&nbsp;";
			$accion_editar = '<a href="#" onclick="calendarioEditar('.$row['id'].')" ><img src="../assets/img/icons/edit_icon.png" width="23"></a>';
			$accion_eliminar = '<a href="#" onclick="calendarioEliminar('.$row['id'].')" ><img src="../assets/img/icons/delete_icon.png" width="22"></a>';
