...
if($action == 'ajax'){
	...
	if ($numrows>0){
    	...
    	while ($row=mysqli_fetch_assoc($query)) {
			...
			$indice = $pagina + $c;
			$espacio = "&nbsp;";
			$accion_editar = '<a href="#"><img src="../assets/img/icons/edit_icon.png" width="23"></a>';
			$accion_eliminar = '<a href="#" class="disabledbutton"><img src="../assets/img/icons/delete_icon.png" width="22"></a>';
        	echo '<tr>';
			echo '   <td>'.$indice.'</td>'.
